...
// Here we are using Redux Thunk so return a function.  Redux Thunk invokes the function and
//  then calls dispatch but the response is received.  The dispatch function is called with a plain 
//  object which then gets passed to the reducers.
