...
class StreamForm extends React.Component {
    ...
    //  the correct props by formProps.input.  We get the input property from 
    //  the Field component.
    ...
    onSubmit=(formValues) => {
        ...
        // this 'onSubmit' function passed in from the parent component, StreamCreate and StreamEdit
    ...
    render() {
        ...
        // handleSubmit supplied in the props object.  Added when we wired up reduxForm().
        return (
